...
*Why do you do statistics? Why don’t scientists just use <u>common
sense?</u>*

It’s a naive question in some ways, but most good questions are. There’s
a lot of good answers to it,[^01.2] but for my money, the best
...
In a classic study, @Evans1983 ran an experiment looking at exactly this. What they found is that when
...
Given this, they were worried about being sued![^01.4] Given
...
that these data *actually* reflect a weak bias in favour of women (sort
...
[@Bickel1975]. Specifically, when they looked at it on a department by department
basis, it turned out that most of the departments actually had a
slightly *higher* success rate for female applicants than for male
...
C\>E\>D\>F\>**A**\>**B**. In other words, what these data seem to be
...
**Simpson’s paradox**. It’s not common, but it does happen in real life,
...
seems pretty *blatantly* gender biased. None of this falls within the
...
then you probably want to look at *both* the aggregated and
...
study are *people*. Real, complicated, gloriously messy, infuriatingly
...
than physics.[^01.5] Basically, we teach statistics to you as
...
*expensive*. If you ever get bored and want to look up how much the
...
statistics should matter to *everyone*. We live in the 21st century, and
data are *everywhere*. Frankly, given the world in which we live these
...
section [A real life example] in the chapter on [Descriptive statistics].
...
[^01.1]: The quote comes from Auden’s 1946 poem Under Which Lyre: A
...
interesting: <https://www.harvardmagazine.com/2007/11/a-poets-warning.html>

[^01.2]: Including the suggestion that common sense is in short supply
among scientists.

[^01.3]: In my more cynical moments I feel like this fact alone explains
95% of what I read on the internet.

[^01.4]: Earlier versions of these notes incorrectly suggested that they
actually were sued. But that’s not true. There’s a nice commentary on
this here:
[https://www.refsmmat.com/posts/2016-05-08-simpsons-paradox-berkeley.
html.](https://www.refsmmat.com/posts/2016-05-08-simpsons-paradox-berkeley) A
big thank you to Wilfried Van Hirtum for pointing this out to me.

[^01.5]: Which might explain why physics is just a teensy bit further
advanced as a science than we are.
