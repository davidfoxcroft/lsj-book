...
```{r fig4-1, chunk.class="enlarge.image", fig.cap="A screenshot of jamovi showing the variables stored in the aflsmallmargins.csv file", out.width = "90%"}
...
<br />
<p class="technical">Technical detail [^04-descriptive-statistics-2]</p>
