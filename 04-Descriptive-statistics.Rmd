...
```{r fig4-1, class.chunk="enlarge-image", fig.cap="A screenshot of jamovi showing the variables stored in the aflsmallmargins.csv file", out.width = "90%"}
...
<span class="technical">[Additional technical detail [^04-descriptive-statistics-2]]</span>
...
```{r fig4-3, class.chunk="enlarge-image", fig.cap="Default descriptives for the AFL 2010 winning margin data (the afl.margins variable)", out.width = "90%"}
...
```{r fig4-5, class.chunk="enlarge-image", fig.cap="A screenshot of jamovi showing the variables stored in the aflsmall finalists.csv file", out.width = "90%"}
knitr::include_graphics("images/Figure12.PNG")
```

```{r fig4-6, class.chunk="enlarge-image", fig.cap="A screenshot of jamovi showing the frequency table for the afl.finalists variable", out.width = "90%"}
...
```{r fig4-7, class.chunk="enlarge-image", fig.cap="A screenshot of jamovi showing the modal value for the afl.margins variable", out.width = "90%"}
...
<span class="technical">[Additional technical detail [^04-descriptive-statistics-4]]</span>
...
<span class="technical"> [Additional technical detail [^04-descriptive-statistics-6]]</span>
...
```{r fig4-9, class.chunk="enlarge-image", fig.cap="A screenshot of jamovi showing the Variance for the first 5 values of the afl.margins variable", out.width = "90%"}
...
<span class="technical">[Additional technical detail [^04-descriptive-statistics-8]]</span>
...
<span class="technical">[Additional technical detail [^04-descriptive-statistics-9]]</span>
...
<span class="technical">[Additional technical detail [^04-descriptive-statistics-10]]</span>

[^04-descriptive-statistics-10]: For reasons that will make sense when we return to this topic in the chapter on [Estimating unknown quantities from a sample] I'll refer to this new quantity as $\hat{\sigma}$ (read as: "sigma hat"), and the formula for this is: $$\hat{\sigma}=\sqrt{\frac{1}{N-1} \sum_{i=1}^{N} ( X_i - \bar{X} )^2}$$
...
<span class="technical">[Additional technical detail [^04-descriptive-statistics-11]]</span>
...
<span class="technical">[Additional technical detail [^04-descriptive-statistics-12]]</span>
...
<span class="technical">[Additional technical detail [^04-descriptive-statistics-14]]</span>
