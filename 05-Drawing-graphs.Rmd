...
```{r fig5-2, class.chunk="enlarge-image", echo=FALSE, fig.cap="jamovi screen showing the histogram check box", out.width = "90%"}
...
```{r fig5-3, class.chunk="enlarge-image", echo=FALSE, fig.cap="A density plot of the afl.margins variable plotted in jamovi", out.width = "90%"}
...
```{r fig5-4, class.chunk="enlarge-image", echo=FALSE, fig.cap="A box plot of the afl.margins variable plotted in jamovi", out.width = "90%"}
...
```{r fig5-5, class.chunk="enlarge-image", echo=FALSE, fig.cap="A violin plot of the afl.margins variable plotted in jamovi, also showing a box plot and data points", out.width = "90%"}
...
```{r fig5-6, class.chunk="enlarge-image", echo=FALSE, fig.cap="jamovi screen shot showing the ‘Split by’ window", out.width = "90%"}
...
```{r fig5-7, class.chunk="enlarge-image", echo=FALSE, fig.cap="Multiple boxplots plotted in jamovi, for the margin by year variables in the aflsmall2 data set", out.width = "90%"}
...
```{r fig5-8, class.chunk="enlarge-image", echo=FALSE, fig.cap="A boxplot showing two very suspicious outliers!", out.width = "90%"}
...
```{r fig5-9, class.chunk="enlarge-image", echo=FALSE, fig.cap="The jamovi filter screen", out.width = "90%"}
knitr::include_graphics("images/Figure30.PNG")
```

```{r fig5-10, class.chunk="enlarge-image", echo=FALSE, fig.cap="Frequency table for ID showing the ID numbers for the two suspicious outliers: 14 and 134", out.width = "90%"}
...
```{r fig5-11, class.chunk="enlarge-image", echo=FALSE, fig.cap="Filtering to include just four AFL teams, and drawing a bar plot in jamovi", out.width = "90%"}
