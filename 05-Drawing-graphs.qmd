...
ggplot() + 
  ...
  geom_pointdensity(data=pumps, aes(x=x, y=y), color="blue", shape=16, size=3, adjust=0.1) +
  ...
  annotate(geom="text", x=9.7, y=20.5, label="100 metres", color="grey50") +
...
#| out.width: 80%
#| classes: .enlarge-image
#| fig-cap: Frequency table for ID showing the ID numbers for the two suspicious outliers, 14 and 134
