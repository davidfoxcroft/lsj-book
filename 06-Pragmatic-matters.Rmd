...
```{r fig6-1, chunk.class="enlarge.image", fig.cap="Contingency table for the speaker and utterances variables", out.width = "90%"}
...
```{r fig6-2, chunk.class="enlarge.image", fig.cap="Contingency table for the speaker and utterances variables, with row percentages", out.width = "90%"}
...
```{r fig6-3, chunk.class="enlarge.image", fig.cap="Contingency table for the speaker and utterances variables, with column percentages", out.width = "90%"}
...
```{r fig6-4, chunk.class="enlarge.image", fig.cap="Creating a new computed variable in jamovi", out.width = "90%"}
...
```{r fig6-5, chunk.class="enlarge.image", fig.cap="Using the $f_x$ button to select functions and variables", out.width = "90%"}
...
```{r fig6-6, chunk.class="enlarge.image",  fig.cap="Collapsing a variable into a smaller number of discrete levels using the jamovi ‘IF’ function", out.width = "90%"}
...
```{r fig6-7, chunk.class="enlarge.image", fig.cap="Creating a new variable transformation using the jamovi ‘Transform’ command", out.width = "90%"}
knitr::include_graphics("images/Figure38.PNG")
```

```{r fig6-8, chunk.class="enlarge.image", fig.cap="Specifying a transformation in jamovi, to be saved as the imaginatively named ‘Transform 1’", out.width = "90%"}
knitr::include_graphics("images/Figure39.PNG")
```

```{r fig6-9, chunk.class="enlarge.image", fig.cap="jamovi transformation into three age categories, using the ‘Add condition’ button", out.width = "90%"}
...
```{r fig6-10, chunk.class="enlarge.image", echo=FALSE, fig.cap="Creating a subset of the nightgarden data using the jamovi ‘Filters’ option", out.width = "90%"}
