...
```{r fig6-1, class.chunk="enlarge-image", fig.cap="Contingency table for the speaker and utterances variables", out.width = "90%"}
...
```{r fig6-2, class.chunk="enlarge-image", fig.cap="Contingency table for the speaker and utterances variables, with row percentages", out.width = "90%"}
...
```{r fig6-3, class.chunk="enlarge-image", fig.cap="Contingency table for the speaker and utterances variables, with column percentages", out.width = "90%"}
...
```{r fig6-4, class.chunk="enlarge-image", fig.cap="Creating a new computed variable in jamovi", out.width = "90%"}
...
```{r fig6-5, class.chunk="enlarge-image", fig.cap="Using the $f_x$ button to select functions and variables", out.width = "90%"}
...
```{r fig6-6, class.chunk="enlarge-image",  fig.cap="Collapsing a variable into a smaller number of discrete levels using the jamovi ‘IF’ function", out.width = "90%"}
...
```{r fig6-7, class.chunk="enlarge-image", fig.cap="Creating a new variable transformation using the jamovi ‘Transform’ command", out.width = "90%"}
knitr::include_graphics("images/Figure38.PNG")
```

```{r fig6-8, class.chunk="enlarge-image", fig.cap="Specifying a transformation in jamovi, to be saved as the imaginatively named ‘Transform 1’", out.width = "90%"}
knitr::include_graphics("images/Figure39.PNG")
```

```{r fig6-9, class.chunk="enlarge-image", fig.cap="jamovi transformation into three age categories, using the ‘Add condition’ button", out.width = "90%"}
...
```{r fig6-10, class.chunk="enlarge-image", echo=FALSE, fig.cap="Creating a subset of the nightgarden data using the jamovi ‘Filters’ option", out.width = "90%"}
knitr::include_graphics("images/Figure42.PNG")
```

When you have done this, you will see that a new column has been added to the spreadsheet window (see Figure \@ref(fig:fig6-10)), labelled 'Filter 1', with the cases where speaker is <u>not</u> 'makka-pakka' greyed-out (i.e., filtered out) and, conversely, the cases where speaker <u>is</u> 'makka-pakka' have a green check mark indicating they are filtered in. You can test this by running 'Exploration' - 'Descriptives' - 'Frequency tables' for the speaker variable and seeing what that shows. Go on, try it!
