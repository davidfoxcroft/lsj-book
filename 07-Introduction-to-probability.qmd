...
ggplot(data=pantsdat, aes(x=eventNames, y=probabilities)) +
  geom_bar(stat='identity', col="black", fill="#3d6da9", alpha=0.6) +
  theme_classic() +
...
ggplot(data=binom1, aes(x = factor(heads), y = pmf)) +
  geom_col(col="#3d6da9", fill="#3d6da9", alpha=0.6, width=.1) +
...
ggplot(data = data.frame(x = seq(-3, 3, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 0, sd = 1), col="#3d6da9", size=1) + 
...
ggplot(data = data.frame(x = seq(0, 10, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 4, sd = 1), col="#3d6da9", size=1) + 
  stat_function(fun = dnorm, n = 1000, args = list(mean = 7, sd = 1), col="#3d6da9", linetype=2, size=1) + 
...
ggplot(data = data.frame(x = seq(0, 10, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 5, sd = 1), col="#3d6da9", size=1) + 
  stat_function(fun = dnorm, n = 1000, args = list(mean = 5, sd = 2), col="#3d6da9", linetype=2, size=1) + 
  scale_x_continuous(breaks = seq(0, 10, 2)) +
  ylab("Probability Density\n") +
  xlab("\nObserved Value") +
  theme_classic()
...
ggplot(data = data.frame(x = seq(-4, 4, 1)), aes(x)) +
  stat_function(fun = dt, n = 1000, args = list(df = 3), col="#3d6da9", size=1) + 
...
ggplot(data = data.frame(x = seq(0, 10, 1)), aes(x)) +
  stat_function(fun = dchisq, n = 1000, args = list(df = 3), col="#3d6da9", size=1) + 
  scale_x_continuous(breaks = seq(0, 10, 2)) +
  ylab("Probability Density\n") +
  xlab("\nObserved Value") +
  theme_classic()
...
ggplot(data = data.frame(x = seq(0, 10, 1)), aes(x)) +
  stat_function(fun = df, n = 1000, args = list(df1 = 3, df2 = 5), col="#3d6da9", size=1) + 
  scale_x_continuous(breaks = seq(0, 10, 2)) +
  ylab("Probability Density\n") +
  xlab("\nObserved Value") +
  theme_classic()
