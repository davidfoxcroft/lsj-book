...
coinflips <- lapply(1:4, function(i) {
    ggplot(data=tibble(flips = 1:1000, heads = cumsum(as.numeric( runif(1000) > .5 )) / (1:1000)),
           aes(x=flips, y=heads)) +
    geom_line(color=blueshade, size=1) +
    ylim(0.3, 0.7) +
    xlim(0, 1000) +
...
ggplot(data = data.frame(x = seq(-3, 3, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 0, sd = 1), col=blueshade, size=1) +
...
ggplot(data = data.frame(x = seq(0, 10, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 4, sd = 1), col=blueshade, size=1) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 7, sd = 1), col=blueshade, linetype=2, size=1) +
...
ggplot(data = data.frame(x = seq(0, 10, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 5, sd = 1), col=blueshade, size=1) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 5, sd = 2), col=blueshade, linetype=2, size=1) +
  scale_x_continuous(breaks = seq(0, 10, 2)) +
  ylab("Probability Density\n") +
  xlab("\nObserved Value") +
  theme_classic()
...
ggplot(data = data.frame(x = seq(-4, 4, 1)), aes(x)) +
  stat_function(fun = dt, n = 1000, args = list(df = 3), col=blueshade, size=1) +
...
ggplot(data = data.frame(x = seq(0, 10, 1)), aes(x)) +
  stat_function(fun = dchisq, n = 1000, args = list(df = 3), col=blueshade, size=1) +
  scale_x_continuous(breaks = seq(0, 10, 2)) +
  ylab("Probability Density\n") +
  xlab("\nObserved Value") +
  theme_classic()
...
ggplot(data = data.frame(x = seq(0, 10, 1)), aes(x)) +
  stat_function(fun = df, n = 1000, args = list(df1 = 3, df2 = 5), col=blueshade, size=1) +
  scale_x_continuous(breaks = seq(0, 10, 2)) +
  ylab("Probability Density\n") +
  xlab("\nObserved Value") +
  theme_classic()
