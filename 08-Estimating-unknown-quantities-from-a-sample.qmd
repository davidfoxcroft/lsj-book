...
The idea is quite simple. Let's say we're talking about IQ scores. To a psychologist the population of interest is a group of actual humans who have IQ scores. A statistician "simplifies" this by operationally defining the population as the probability distribution depicted in @fig-fig8-4 (a). IQ tests are designed so that the average IQ is 100, the standard deviation of IQ scores is 15, and the distribution of IQ scores is normal. These values are referred to as the **population parameters** because they are characteristics of the entire population. That is, we say that the population mean µ is 100 and the population standard deviation $\sigma$ is 15.
...
[^08-estimating-unknown-quantities-from-a-sample-8]: This quote appears on a great many t-shirts and websites, and even gets a mention in a few academic papers (e.g., <a href="https://jse.amstat.org/v10n3/friedman.html"
    target="_blank">https://jse.amstat.org/v10n3/friedman.html</a>), but I've never found the original source.
