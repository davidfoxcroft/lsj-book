...
plota <- ggplot(data = data.frame(x = seq(60, 140, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 100, sd = 15), col="blue", size=1) + 
...
plotb <- ggplot(data = data.frame(x = rnorm(100, 100, 15)), aes(x)) +
  geom_histogram(binwidth=6, col="blue", fill="blue", alpha=0.6) + 
  scale_x_continuous(breaks = seq(60, 140, 20)) +
  ylab("Frequency\n") +
  xlab("\nIQ score") +
  theme_classic()
...
ggplot(data = sdm_data_means, aes(x = sample_means )) +
  geom_histogram(aes(y =..density..), binwidth=4, col="blue", fill="blue", alpha=0.7) + 
...
sampling_plots <- lapply(sampling_plots_df$n, function(i) {
  ...
  ggplot(data=sdm_data_mean, aes(x=sample_mean)) +
  geom_histogram(aes(y =..density..), binwidth=0.0339, col="blue", fill="blue", alpha=0.6) +
...
ggplot(data = sdsd, aes(x = sd )) +
  geom_histogram(binwidth=2.5, col="blue", fill="blue", alpha=0.6) + 
...
plotcol <- with(ci.demo.10, ifelse(lci>100 | uci<100, "blue", "darkgrey"))
...
p.ci1  <- ggplot(data=ci.demo.10, aes(x=Replication, y=ci_m)) +
  ...
  geom_hline(yintercept=100, col="darkgrey", linetype="dashed") +
  geom_text(aes(label = ifelse(plotcol == "blue", "*", "")), col="blue", size=10, nudge_y = asterisk_pos) +
  xlab("\nReplication Number") +
  ylab("Mean IQ\n") +
  ggtitle("(b) Sample Size = 10") +
  scale_fill_identity() +
...
plotcol <- with(ci.demo.25, ifelse(lci>100 | uci<100, "blue", "darkgrey"))
asterisk_pos <- 118-ci_m
ci.demo.10 <- cbind(ci.demo.10, plotcol, asterisk_pos)
