...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  ...
  labs(x = "\nNumber of correct responses (X)") +
  geom_text(x=27, y=.035, label="lower critical region\n(2.5% of the distribution)", size=5) +
  geom_segment(x = 40, y = .025, xend = 15, yend = .025,
               arrow = arrow(length = unit(0.03, "npc"))) +
  geom_text(x=75, y=.035, label="upper critical region\n(2.5% of the distribution)", size=5) +
...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  ...
  labs(x = "\nNumber of correct responses (X)") +
  geom_text(x=73, y=.04, label="critical region\n(5% of the distribution)", size=5) +
...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  ...
  geom_segment(x = 40, y = .06, xend = 10, yend = .06,
               arrow = arrow(length = unit(0.03, "npc"))) +
  geom_label(aes(x=75, y=.07, label="upper critical region\n(2.5% of the distribution)"), size=5, label.size=NA, fill="white", alpha=0.025) +
  geom_segment(x = 61, y = .06, xend = 90, yend = .06,
               arrow = arrow(length = unit(0.03, "npc"))) +
  scale_x_discrete(breaks=seq(0,100,20)) +
  scale_colour_identity() +
