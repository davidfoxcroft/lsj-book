...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  geom_col(col=blueshade, fill=blueshade, alpha=0.6, width=.5) +
...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  geom_bar(aes(colour=plotcol, fill=plotcol), width=.5, stat = "identity") +
...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  ...
  geom_segment(x = 40, y = .06, xend = 10, yend = .06,
               arrow = arrow(length = unit(0.03, "npc")), stat = "unique") +
  geom_label(aes(x=75, y=.07, label="upper critical region\n(2.5% of the distribution)"), size=5, , stat = "unique", label.size=NA, fill="white", alpha=0.9) +
