...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  geom_col(col=blueshade, fill=blueshade, alpha=0.6, width=.3) +
...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  geom_bar(aes(colour=plotcol, fill=plotcol), width=.3, stat = "identity") +
  ggtitle("Critical Regions for a Two-sided Test") +
  labs(x = "\nNumber of correct responses (X)") +
  geom_text(x=22, y=.035, label="lower critical region\n(2.5% of the distribution)", size=3, check_overlap = TRUE) +
...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  ...
  labs(x = "\nNumber of correct responses (X)") +
  geom_text(x=78, y=.04, label="critical region\n(5% of the distribution)", size=3, check_overlap = TRUE) +
  geom_segment(x = 59, y = .028, xend = 85, yend = .028,
               arrow = arrow(length = unit(0.03, "npc")), stat = "unique") +
  scale_x_discrete(breaks=seq(0,100,20)) +
  scale_colour_identity() +
  scale_fill_identity() +
...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  ...
  geom_segment(x = 40, y = .06, xend = 10, yend = .06,
               arrow = arrow(length = unit(0.03, "npc")), stat = "unique") +
  geom_text(x=78, y=.07, label="upper critical region\n(2.5% of the distribution)", size=3, check_overlap = TRUE) +
  geom_segment(x = 65, y = .06, xend = 90, yend = .06,
               arrow = arrow(length = unit(0.03, "npc")), stat = "unique") +
  scale_x_discrete(breaks=seq(0,100,20)) +
  scale_colour_identity() +
  scale_fill_identity() +
...
ggplot(data=binom1, aes(x = factor(success), y = pmf+.001)) +
  ...
  geom_segment(x = 40, y = .06, xend = 10, yend = .06,
               arrow = arrow(length = unit(0.03, "npc")), stat = "unique") +
  geom_label(aes(x=75, y=.07, label="upper critical region\n(2.5% of the distribution)"), size=3, , stat = "unique", label.size=NA, fill="white", alpha=0.9) +
  geom_segment(x = 61, y = .06, xend = 90, yend = .06,
               arrow = arrow(length = unit(0.03, "npc")), stat = "unique") +
  scale_x_discrete(breaks=seq(0,100,20)) +
  scale_colour_identity() +
  scale_fill_identity() +
