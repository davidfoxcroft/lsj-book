...
ggplot(data = data.frame(x = seq(0, 12, 1)), aes(x)) +
  stat_function(aes(linetype = 'df = 3'), fun = dchisq, n = 1000, args = list(df = 3), col="#3d6da9", size=1) + 
  stat_function(aes(linetype = 'df = 4'), fun = dchisq, n = 1000, args = list(df = 4), col="#3d6da9", size=1) + 
  stat_function(aes(linetype = 'df = 5'), fun = dchisq, n = 1000, args = list(df = 5), col="#3d6da9", size=1) + 
...
ggplot(data = data.frame(x = seq(0, 12, 0.01)), aes(x)) +
  stat_function(fun = dchisq, n = 1000, args = list(df = 3), linetype = "solid", col="black", size=1) + 
  stat_function(fun = dchisq, n = 1000, args = list(df = 3), geom = "area",
                fill = "#3d6da9", alpha=0.8, xlim = c(7.82, 12)) + 
  scale_x_continuous(breaks = seq(0, 12, 2)) +
