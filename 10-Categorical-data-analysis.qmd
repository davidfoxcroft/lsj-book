...
ggplot(data = data.frame(x = seq(0, 12, 1)), aes(x)) +
  stat_function(aes(linetype = 'df = 3'), fun = dchisq, n = 1000, args = list(df = 3), col=blueshade, size=1) + 
  stat_function(aes(linetype = 'df = 4'), fun = dchisq, n = 1000, args = list(df = 4), col=blueshade, size=1) + 
  stat_function(aes(linetype = 'df = 5'), fun = dchisq, n = 1000, args = list(df = 5), col=blueshade, size=1) + 
