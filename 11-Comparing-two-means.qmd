...
#| fig-alt: Two side-by-side bell curve graphs comparing the null hypothesis and alternative hypothesis. The left graph shows the null hypothesis with $\mu$ = $\mu$₀ and σ = σ₀. The right graph shows the alternative hypothesis with $\mu$ ≠ $\mu$₀ and σ = σ₀. The x-axis is labeled "Value of X".
