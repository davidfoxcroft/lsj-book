...
load("data_and_table_files/zeppo.Rdata") #grades 
ggplot(as.data.frame(grades), aes(x=grades)) +
  geom_histogram(aes(y =..density..), binwidth=5, col="#3d6da9", fill="#3d6da9", alpha=0.4) + 
  stat_function(fun = dnorm, args = list(mean = 67.7, sd = sd(grades)), col="black", size=1) + 
  xlab("\nGrades") +
  theme_classic() +
  theme(
...
p1 <- ggplot(data = data.frame(x = seq(-4, 4, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 0, sd = 1), col="black", size=1) + 
...
p2 <- ggplot(data = data.frame(x = seq(-4, 4, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = -.75, sd = 1), col="black", size=1) + 
...
p1 <- ggplot(data = data.frame(x = seq(-3, 3, 0.1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean=0, sd=1), geom = "area",
                fill = "#3d6da9", alpha=0.4, xlim = c(-3, -1.96))  + 
  stat_function(fun = dnorm, n = 1000, args = list(mean=0, sd=1), geom = "area",
                fill = "#3d6da9", alpha=0.4, xlim = c(1.96, 3))  + 
  stat_function(fun = dnorm, n = 1000, args = list(mean=0, sd=1), col="black", size=1) +
...
p2 <- ggplot(data = data.frame(x = seq(-3, 3, 0.1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean=0, sd=1), geom = "area",
                fill = "#3d6da9", alpha=0.4, xlim = c(1.64, 3))  + 
  stat_function(fun = dnorm, n = 1000, args = list(mean=0, sd=1), col="black", size=1) +
  xlab("\nValue of z Statistic") + 
...
p1 <- ggplot(data = data.frame(x = seq(-4, 4, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 0, sd = 1), col="grey", linetype=2, size=1) + 
  stat_function(fun = dt, n = 1000, args = list(df = 2), col="black", size=1) + 
  scale_x_continuous(breaks = seq(-4, 4, 2)) +
  ggtitle("df = 2") +
...
p2 <- ggplot(data = data.frame(x = seq(-4, 4, 1)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 0, sd = 1), col="grey", linetype=2, size=1) + 
  stat_function(fun = dt, n = 1000, args = list(df = 20), col="black", size=1) + 
  scale_x_continuous(breaks = seq(-4, 4, 2)) +
  ggtitle("df = 10") +
  xlab("\nValue of t-statistic") +
  theme_classic() +
...
#| fig-align: left
#| out.width: 70%
#| fig-cap: Box and violin plots showing the distribution of grades for students in Anastasia's and Bernadette's classes. Visually, these suggest that students in Anastasia's class may be getting slightly better grades on average, though they also seem a bit more variable
...
p1 <- ggplot(data = data.frame(x = seq(30, 110, 10)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 70, sd = 9), col="black", size=1) + 
...
p2 <- ggplot(data = data.frame(x = seq(30, 110, 10)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 60, sd = 9), col="black", size=1) + 
  stat_function(fun = dnorm, n = 1000, args = list(mean = 75, sd = 9), col="black", size=1) + 
  scale_x_continuous(breaks = seq(40, 100, 20)) +
...
p1 <- ggplot(data = data.frame(x = seq(30, 110, 10)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 70, sd = 6.5), col="black", size=1) + 
  scale_x_continuous(breaks = seq(40, 100, 20)) +
...
p2 <- ggplot(data = data.frame(x = seq(30, 110, 10)), aes(x)) +
  stat_function(fun = dnorm, n = 1000, args = list(mean = 60, sd = 6.5), col="black", size=1) + 
  stat_function(fun = dnorm, n = 1000, args = list(mean = 75, sd = 7.95), col="black", size=1) + 
  scale_x_continuous(breaks = seq(40, 100, 20)) +
...
![Histogram showing the improvement made by each student in Dr Chico's class. Notice that almost the entire distribution is above zero - the vast majority of students did improve their performance from the first test to the second one](images/fig11-14.png){#fig-fig11-14 fig-align="left" width=60%}
...
p1 <- ggplot(df, aes(x=y)) +
  geom_histogram(bins=10, col="white", fill="#3d6da9", alpha=0.6) +
  xlab("\nValue") +
  ylab("Frequency\n") +
...
ggplot(W_sampdist) + 
  geom_density(aes(x=W_10), adjust=3, col = "#3d6da9", linetype = "solid", show.legend=FALSE) +
  stat_density(aes(x=W_10, linetype = "N = 10"), alpha = 0, 
                  geom="line", position="identity") +
  geom_density(aes(x=W_20), adjust=3, col = "#3d6da9", linetype = "dashed", show.legend=FALSE) +
  stat_density(aes(x=W_20, linetype = "N = 20"), alpha = 0, 
                  geom="line", position="identity") +
  geom_density(aes(x=W_50), adjust=3, col = "#3d6da9", linetype = "dotted", show.legend=FALSE)+
  stat_density(aes(x=W_50, linetype = "N = 50"), alpha = 0, 
                  geom="line", position="identity") +
  scale_linetype_manual(values = c('solid', 'dashed', 'dotted')) +
  guides(linetype = guide_legend(override.aes = list(col = "#3d6da9", alpha = 1) ) ) +
  xlab("\nValue of W") +
