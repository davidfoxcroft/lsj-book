...
::: {#fig-fig12-2 layout-ncol="2" layout-valign="bottom" width="90%" fig-pos="H"}
...
[^12-correlation-and-linear-regression-5]: The $\epsilon$ symbol is the Greek letter epsilon. It's traditional to use $\epsilon_i$ or $e_i$ to denote a residual: $$\epsilon_i=Y_i-\hat{Y}_i$$ which in turn means that we can write down the complete linear regression model as: $$Y_i=b_0+b_1X_i+\epsilon_i$$
