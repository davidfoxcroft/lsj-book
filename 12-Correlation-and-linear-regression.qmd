...
::: {#fig-fig12-1 layout-ncol="3" layout-valign="bottom" width="95%"}
...
::: {#fig-fig12-2 layout-ncol="2" layout-valign="bottom" width="95%" }
...
The two variables are $x$ and $y$, and we have two coefficients, $a$ and $b$.[^12-correlation-and-linear-regression-4] The coefficient $a$ represents the y-intercept of the line, and coefficient $b$ represents the slope of the line. The intercept is interpreted as "the value of y that you get when $x = 0$". Similarly, a slope of b means that if you increase the x-value by 1 unit, then the y-value goes up by b units, and a negative slope means that the y-value would go down rather than up. We use the exact same formula for a regression line. If $Y$ is the outcome variable (the DV) and $X$ is the predictor variable (the $IV$), then the formula that describes our regression is written like this:
...
::: {#fig-fig12-20 layout-nrow=2 width=90% fig-pos='H'}
