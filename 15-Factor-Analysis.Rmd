...
```{r fig15-3, chunk.class = "enlarge.image", fig.cap="The jamovi EFA analysis window", out.width = "90%"}
knitr::include_graphics("images/Figure174.PNG")
```

```{r fig15-4, chunk.class = "enlarge.image", fig.cap="jamovi EFA assumption checks for the personality questionnaire data", out.width = "50%"}
...
```{r fig15-5, chunk.class = "enlarge.image", fig.cap="Scree plot of the personality data in jamovi EFA, showing a noticeable inflection and levelling off after point 5 (the 'elbow')", out.width = "90%"}
...
```{r fig15-6, chunk.class = "enlarge.image", fig.cap="Factor summary statistics and correlations for a five factor solution in jamovi EFA", out.width = "90%"}
...
```{r fig15-7, chunk.class = "enlarge.image", fig.cap="Factor loadings for a five factor solution in jamovi EFA", out.width = "90%"}
...
```{r fig15-8, chunk.class = "enlarge.image", fig.cap="Recode variable using the jamovi Transform command", out.width = "90%"}
knitr::include_graphics("images/Figure178.PNG")
```

```{r fig15-9, chunk.class = "enlarge.image", fig.cap="Compute new scale score variable using the jamovi Computed variable command", out.width = "90%"}
...
```{r fig15-10, chunk.class = "enlarge.image", fig.cap="Rj editor commands for creating optimally weighted factor scores for the five factor solution", out.width = "90%"}
...
```{r fig15-12, chunk.class = "enlarge.image", fig.cap="Comparing differences in Agreeableness factor-based scores between males and females", out.width = "90%"}
...
```{r fig15-13, chunk.class = "enlarge.image", fig.cap="The jamovi PCA analysis window", out.width = "90%"}
...
```{r fig15-14, chunk.class = "enlarge.image", fig.cap="jamovi PCA assumption checks for the personality item data", out.width = "80%"}
...
```{r fig15-15, chunk.class = "enlarge.image", fig.cap="Scree plot of the personality item data in jamovi PCA, showing the levelling off point, the 'elbow', after component 5", out.width = "90%"}
...
```{r fig15-16, chunk.class = "enlarge.image", fig.cap="Component summary statistics and correlations for a five component solution in jamovi PCA", out.width = "90%"}
...
```{r fig15-17, chunk.class = "enlarge.image", fig.cap="Component loadings for a five component solution in jamovi PCA", out.width = "90%"}
...
```{r fig15-18, chunk.class = "enlarge.image", fig.cap="Rj editor commands for creating optimally weighted component scores for the five component solution", out.width = "90%"}
...
```{r fig15-19, chunk.class = "enlarge.image", fig.cap="Initial pre-specification of latent factor structure for the five factor personality scales, for use in CFA", out.width = "80%"}
...
```{r fig15-20, chunk.class = "enlarge.image", fig.cap="The jamovi CFA analysis window", out.width = "90%"}
...
```{r fig15-22, chunk.class = "enlarge.image", fig.cap="The jamovi CFA Factor Loadings table for our CFA model", out.width = "90%"}
knitr::include_graphics("images/Figure192.PNG")
```

```{r fig15-23, chunk.class = "enlarge.image", fig.cap="The jamovi CFA Factor Covariances table for our CFA model", out.width = "90%"}
...
```{r fig15-24, chunk.class = "enlarge.image", fig.cap="The jamovi CFA Factor Loadings Modification Indices", out.width = "90%"}
...
```{r fig15-25, chunk.class = "enlarge.image", fig.cap="Residual Covariance Modification Indices produced by jamovi", out.width = "70%"}
...
```{r fig15-26, chunk.class = "enlarge.image", fig.cap="The Attributional Style Questionnaire (ASQ) for negative events", out.width = "90%"}
...
```{r fig15-27, chunk.class = "enlarge.image", fig.cap="Six questions on the ASQ for each of the Internality, Stability and Globality dimensions", out.width = "80%"}
...
```{r fig15-28, chunk.class = "enlarge.image", fig.cap="Initial pre-specification of latent factor structure for the ASQ", out.width = "80%"}
...
```{r fig15-30, chunk.class = "enlarge.image", fig.cap="The jamovi CFA analysis window", out.width = "90%"}
...
```{r fig15-31, chunk.class = "enlarge.image", fig.cap="The jamovi CFA Model Fit results for our CFA MTMM model", out.width = "90%"}
...
```{r fig15-32, chunk.class = "enlarge.image", fig.cap="The jamovi CFA Factor Loadings and Covariances tables for our CFA MTMM model", out.width = "90%"}
...
```{r fig15-33, chunk.class = "enlarge.image", fig.cap="The jamovi CFA Factor Loadings Modification Indices", out.width = "80%"}
...
```{r fig15-34, chunk.class = "enlarge.image", fig.cap="The jamovi CFA Residual Covariances Modification Indices", out.width = "80%"}
...
```{r fig15-35, chunk.class = "enlarge.image", fig.cap="The jamovi Reliability Analysis window", out.width = "90%"}
...
```{r fig15-36, chunk.class = "enlarge.image", fig.cap="The jamovi Reliability Analysis results for the Agreeableness factor", out.width = "90%"}
