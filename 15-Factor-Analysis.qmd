...
\placetextbox{0.20}{0.05}{\scriptsize{CC BY-SA 4.0}}
...
```{r}
#| label: tbl-tab15-1
#| tbl-cap: Twenty-five observed variable items organised by five putative personality factors in the dataset *bfi_sample.csv*
#| tbl-pos: ht!
huxtabs[[15]][[1]]  %>%
