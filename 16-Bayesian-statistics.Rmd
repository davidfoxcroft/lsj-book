...
```{r fig16-1, fig.cap="How badly can things go wrong if you re-run your tests every time new data arrive? If you are a frequentist, the answer is 'very wrong'”, out.width = "90%"}
knitr::include_graphics("images/adaptivesampling.PNG")
```
