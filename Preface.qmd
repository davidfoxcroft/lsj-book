...
## Data files used in this book {.unnumbered}

Data sets used in the book are available as data files to use in jamovi. All the data files you need can be accessed within jamovi via an add-on module in the jamovi library. Or you can can download the data files from the [lsj website](https://www.learnstatswithjamovi.com).

## Preface to Version 0.75 {.unnumbered}
...
## Preface to Version 0.70 {.unnumbered .unlisted}
...
## Preface to Version 0.65 {.unnumbered .unlisted}
...
## Preface to Version 0.6 {.unnumbered .unlisted}
...
## Preface to Version 0.5 {.unnumbered .unlisted}
...
## Preface to Version 0.4 {.unnumbered .unlisted}
...
## Preface to Version 0.3 {.unnumbered .unlisted}
...
Soft copy:
[www.compcogscisydney.com/learning-statistics-with-r.html](https://www.compcogscisydney.com/learning-statistics-with-r.html)  
Hard copy:
[www.lulu.com/content/13570633](https://www.lulu.com/content/13570633)  
[***Ed: these links are defunct, try this instead:
