...
goal is to give you an [Introduction to probability] theory, sampling and estimation in the chapter on [Estimating unknown quantities from a sample] and statistical [Hypothesis testing]. Before we get started though, I want
