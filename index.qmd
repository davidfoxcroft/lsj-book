...
:::{.callout-note}
The latest build of the book is shown on this website, and can be downloaded as a free pdf from the pdf icon / link in the top menu. A free pdf of the book is also available for download from Open Book Publishers - this pdf is likely not the very latest build however ([https://www.openbookpublishers.com/books/10.11647/obp.0333](https://www.openbookpublishers.com/books/10.11647/obp.0333)). All the data files you need can be accessed for free within jamovi via an add-on module in the jamovi library. Or you can download the files from [https://www.learnstatswithjamovi.com](https://www.learnstatswithjamovi.com). 
:::
