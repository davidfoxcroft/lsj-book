...
\begin{table}[ht]
\caption{\label{tbl-tab8-1}Ten replications of the IQ experiment, each with a sample size of
\(( N = 5 )\) }\tabularnewline
...
\begin{table}[ht]
\caption{\label{tbl-tab9-5}Typical translations of \emph{p}-value levels }\tabularnewline
...
\begin{table}[ht]
\caption{\label{tbl-tab10-9}Contingency table of the \emph{salem.csv} data }\tabularnewline
...
\begin{table}[ht]
\caption{\label{tbl-tab10-13}Cross-tabulating first against second choice with the
\emph{Randomness.omv} (cards) data }\tabularnewline
