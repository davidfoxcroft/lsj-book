...
\noindent
Hopefully that's pretty clear. It's also worth nothing that mathematicians prefer to talk about things in general rather than specific things, so you'll also see the notation $O_i$, which refers to the number of observations that fall within the $i$-th category (where $i$ could be 1, 2, 3 or 4). Finally, if we want to refer to the set of all observed frequencies, statisticians group all of observed values into a vector\FOOTNOTE{A vector is a sequence of data elements of the same basic type}, which I'll refer to as $\bm{O}$. 
$$
\bm{O} = (O_1, O_2, O_3, O_4)
$$
Again, there's nothing new or interesting here: it's just notation. If I say that $\bm{O}~=~(35, 51, 64, 50)$ all I'm doing is describing the table of observed frequencies (i.e., \rtext{observed}), but I'm referring to it using mathematical notation. 
...
\begin{figure}
\begin{center}
\epsfig{file=../img/chisquare/chiSqTest.pdf,clip=true,width=11cm}
...
\begin{figure}
\begin{center}
\epsfig{file=../img/chisquare/chisquared_critvalues.png,clip=true,width=12cm}
...
So if our calculated $\chi^2$ statistic is bigger than the critical value of 7.82, then we can reject the null hypothesis. Since we actually calculated that before (i.e., $\chi^2 = 8.44$) we can reject the null hypothesis.  And that's it, basically. You now know ``Pearson's $\chi^2$ test for the goodness of fit''. Lucky you.
...
\begin{figure}
\begin{center}
\epsfig{file=../img/chisquare/chisquared_analysis1.png,clip=true,width=12cm}
...
\begin{figure}
\begin{center}
\epsfig{file=../img/chisquare/chisquared_analysis2.png,clip=true,width=12cm}
...
\begin{figure}
\begin{center}
\epsfig{file=../img/chisquare/Fisher.png,clip=true,width=12cm}
...
\begin{figure}
\begin{center}
\epsfig{file=../img/chisquare/McNemar.png,clip=true,width=12cm}
...
\begin{figure}
\begin{center}
\epsfig{file=../img/chisquare/ind_paired.png,clip=true,width=12cm}
