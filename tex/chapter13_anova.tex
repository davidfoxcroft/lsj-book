...
To perform a one-way related ANOVA in jamovi, open the one-way related ANOVA dialogue box, as in Figure \ref{fig:RManova1}, via \rtext{ANOVA - Repeated Measures ANOVA}. Then:
